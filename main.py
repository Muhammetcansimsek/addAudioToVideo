...
parser.add_argument("-e", "--end", help="The end duration of the video file, default is the lenght of the video file", default=False)
...
# usee the volume factor to increase / decrease volume
...
# setting the start & end of the audio clip to 'start' and 'end' parameters
